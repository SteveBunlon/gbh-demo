...
const { companyLocale } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('companyLocale');

// This file contains the logic of every route in Forest Admin for the collection companyLocale:
...
// Create a Company Locale
router.post('/companyLocale', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Company Locale
router.put('/companyLocale/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Company Locale
router.delete('/companyLocale/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Company Locales
router.get('/companyLocale', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Company Locales
router.get('/companyLocale/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Company Locale
router.get('/companyLocale/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Company Locales
router.get('/companyLocale.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Company Locales
router.delete('/companyLocale', permissionMiddlewareCreator.delete(), (request, response, next) => {
