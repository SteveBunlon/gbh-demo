...
const { agencyType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('agencyType');

// This file contains the logic of every route in Forest Admin for the collection agencyType:
...
router.post('/agencyType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Agency Type
router.put('/agencyType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/agencyType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Agency Types
router.get('/agencyType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Agency Types
router.get('/agencyType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Agency Type
router.get('/agencyType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Agency Types
router.get('/agencyType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Agency Types
router.delete('/agencyType', permissionMiddlewareCreator.delete(), (request, response, next) => {
