...
const { attachmentType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('attachmentType');

// This file contains the logic of every route in Forest Admin for the collection attachmentType:
...
// Create a Attachment Type
router.post('/attachmentType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Attachment Type
router.put('/attachmentType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Attachment Type
router.delete('/attachmentType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/attachmentType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Attachment Types
router.get('/attachmentType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Attachment Type
router.get('/attachmentType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Attachment Types
router.get('/attachmentType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Attachment Types
router.delete('/attachmentType', permissionMiddlewareCreator.delete(), (request, response, next) => {
