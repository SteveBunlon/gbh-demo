...
const { extraDetailTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('extraDetailTranslation');

// This file contains the logic of every route in Forest Admin for the collection extraDetailTranslation:
...
// Create a Extra Detail Translation
router.post('/extraDetailTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Extra Detail Translation
router.put('/extraDetailTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Extra Detail Translation
router.delete('/extraDetailTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Extra Detail Translations
router.get('/extraDetailTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Extra Detail Translations
router.get('/extraDetailTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Extra Detail Translation
router.get('/extraDetailTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Extra Detail Translations
router.get('/extraDetailTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Extra Detail Translations
router.delete('/extraDetailTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
