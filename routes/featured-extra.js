...
const { featuredExtra } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('featuredExtra');

// This file contains the logic of every route in Forest Admin for the collection featuredExtra:
...
// Create a Featured Extra
router.post('/featuredExtra', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Featured Extra
router.put('/featuredExtra/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Featured Extra
router.delete('/featuredExtra/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Featured Extras
router.get('/featuredExtra', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Featured Extras
router.get('/featuredExtra/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Featured Extra
router.get('/featuredExtra/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Featured Extras
router.get('/featuredExtra.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Featured Extras
router.delete('/featuredExtra', permissionMiddlewareCreator.delete(), (request, response, next) => {
