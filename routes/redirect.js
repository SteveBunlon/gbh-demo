...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('redirect');

// This file contains the logic of every route in Forest Admin for the collection redirect:
...
// Create a Redirect
router.post('/redirect', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Redirect
router.put('/redirect/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Redirect
router.delete('/redirect/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/redirect', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Redirects
router.get('/redirect/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Redirect
router.get('/redirect/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/redirect.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Redirects
router.delete('/redirect', permissionMiddlewareCreator.delete(), (request, response, next) => {
