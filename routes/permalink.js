...
const { permalink } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('permalink');

// This file contains the logic of every route in Forest Admin for the collection permalink:
...
// Create a Permalink
router.post('/permalink', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Permalink
router.put('/permalink/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Permalink
router.delete('/permalink/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Permalinks
router.get('/permalink', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Permalinks
router.get('/permalink/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Permalink
router.get('/permalink/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Permalinks
router.get('/permalink.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Permalinks
router.delete('/permalink', permissionMiddlewareCreator.delete(), (request, response, next) => {
