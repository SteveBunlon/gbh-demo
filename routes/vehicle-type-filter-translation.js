...
const { vehicleTypeFilterTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('vehicleTypeFilterTranslation');

// This file contains the logic of every route in Forest Admin for the collection vehicleTypeFilterTranslation:
...
// Create a Vehicle Type Filter Translation
router.post('/vehicleTypeFilterTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Vehicle Type Filter Translation
router.put('/vehicleTypeFilterTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Vehicle Type Filter Translation
router.delete('/vehicleTypeFilterTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Vehicle Type Filter Translations
router.get('/vehicleTypeFilterTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Vehicle Type Filter Translations
router.get('/vehicleTypeFilterTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Vehicle Type Filter Translation
router.get('/vehicleTypeFilterTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Vehicle Type Filter Translations
router.get('/vehicleTypeFilterTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Vehicle Type Filter Translations
router.delete('/vehicleTypeFilterTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
