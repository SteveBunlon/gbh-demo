...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('brand');

// This file contains the logic of every route in Forest Admin for the collection brand:
...
// Create a Brand
router.post('/brand', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Brand
router.put('/brand/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Brand
router.delete('/brand/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/brand', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/brand/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Brand
router.get('/brand/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/brand.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/brand', permissionMiddlewareCreator.delete(), (request, response, next) => {
