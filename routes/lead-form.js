...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('leadForm');

// This file contains the logic of every route in Forest Admin for the collection leadForm:
...
// Create a Lead Form
router.post('/leadForm', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Lead Form
router.put('/leadForm/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Lead Form
router.delete('/leadForm/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Lead Forms
router.get('/leadForm', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Lead Forms
router.get('/leadForm/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Lead Form
router.get('/leadForm/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Lead Forms
router.get('/leadForm.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Lead Forms
router.delete('/leadForm', permissionMiddlewareCreator.delete(), (request, response, next) => {
