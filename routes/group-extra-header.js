...
const { groupExtraHeader } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('groupExtraHeader');

// This file contains the logic of every route in Forest Admin for the collection groupExtraHeader:
...
// Create a Group Extra Header
router.post('/groupExtraHeader', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Group Extra Header
router.put('/groupExtraHeader/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Group Extra Header
router.delete('/groupExtraHeader/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Group Extra Headers
router.get('/groupExtraHeader', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Group Extra Headers
router.get('/groupExtraHeader/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Group Extra Header
router.get('/groupExtraHeader/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Group Extra Headers
router.get('/groupExtraHeader.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Group Extra Headers
router.delete('/groupExtraHeader', permissionMiddlewareCreator.delete(), (request, response, next) => {
