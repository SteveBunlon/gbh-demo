...
const { featuredVehicle } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('featuredVehicle');

// This file contains the logic of every route in Forest Admin for the collection featuredVehicle:
...
router.post('/featuredVehicle', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Featured Vehicle
router.put('/featuredVehicle/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Featured Vehicle
router.delete('/featuredVehicle/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Featured Vehicles
router.get('/featuredVehicle', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Featured Vehicles
router.get('/featuredVehicle/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Featured Vehicle
router.get('/featuredVehicle/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Featured Vehicles
router.get('/featuredVehicle.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Featured Vehicles
router.delete('/featuredVehicle', permissionMiddlewareCreator.delete(), (request, response, next) => {
