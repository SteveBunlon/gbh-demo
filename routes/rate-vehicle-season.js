...
const { rateVehicleSeason } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('rateVehicleSeason');

// This file contains the logic of every route in Forest Admin for the collection rateVehicleSeason:
...
// Create a Rate Vehicle Season
router.post('/rateVehicleSeason', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Rate Vehicle Season
router.put('/rateVehicleSeason/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Rate Vehicle Season
router.delete('/rateVehicleSeason/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Rate Vehicle Seasons
router.get('/rateVehicleSeason', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Rate Vehicle Seasons
router.get('/rateVehicleSeason/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Rate Vehicle Season
router.get('/rateVehicleSeason/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Rate Vehicle Seasons
router.get('/rateVehicleSeason.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Rate Vehicle Seasons
router.delete('/rateVehicleSeason', permissionMiddlewareCreator.delete(), (request, response, next) => {
