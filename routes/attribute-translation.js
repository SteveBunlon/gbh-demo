...
const { attributeTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('attributeTranslation');

// This file contains the logic of every route in Forest Admin for the collection attributeTranslation:
...
// Create a Attribute Translation
router.post('/attributeTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Attribute Translation
router.put('/attributeTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Attribute Translation
router.delete('/attributeTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Attribute Translations
router.get('/attributeTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Attribute Translations
router.get('/attributeTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Attribute Translation
router.get('/attributeTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Attribute Translations
router.get('/attributeTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Attribute Translations
router.delete('/attributeTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
