...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('media');

// This file contains the logic of every route in Forest Admin for the collection media:
...
// Update a Media
router.put('/media/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Media
router.delete('/media/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Media
router.get('/media', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/media/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Media
router.get('/media/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Media
router.get('/media.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Media
router.delete('/media', permissionMiddlewareCreator.delete(), (request, response, next) => {
