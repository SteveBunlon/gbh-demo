...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('vehicleCategory');

// This file contains the logic of every route in Forest Admin for the collection vehicleCategory:
...
router.post('/vehicleCategory', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/vehicleCategory/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/vehicleCategory/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/vehicleCategory', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Vehicle Categories
router.get('/vehicleCategory/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/vehicleCategory/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Vehicle Categories
router.get('/vehicleCategory.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Vehicle Categories
router.delete('/vehicleCategory', permissionMiddlewareCreator.delete(), (request, response, next) => {
