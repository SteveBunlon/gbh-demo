...
const { extraTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('extraTranslation');

// This file contains the logic of every route in Forest Admin for the collection extraTranslation:
...
// Create a Extra Translation
router.post('/extraTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Extra Translation
router.put('/extraTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Extra Translation
router.delete('/extraTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Extra Translations
router.get('/extraTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Extra Translations
router.get('/extraTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Extra Translation
router.get('/extraTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Extra Translations
router.get('/extraTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Extra Translations
router.delete('/extraTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
