...
const { typeRequest } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('typeRequest');

// This file contains the logic of every route in Forest Admin for the collection typeRequest:
...
router.post('/typeRequest', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Type Request
router.put('/typeRequest/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Type Request
router.delete('/typeRequest/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Type Requests
router.get('/typeRequest', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Type Requests
router.get('/typeRequest/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Type Request
router.get('/typeRequest/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Type Requests
router.get('/typeRequest.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Type Requests
router.delete('/typeRequest', permissionMiddlewareCreator.delete(), (request, response, next) => {
