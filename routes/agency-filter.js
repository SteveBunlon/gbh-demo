...
const { agencyFilter } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('agencyFilter');

// This file contains the logic of every route in Forest Admin for the collection agencyFilter:
...
// Create a Agency Filter
router.post('/agencyFilter', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Agency Filter
router.put('/agencyFilter/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Agency Filter
router.delete('/agencyFilter/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Agency Filters
router.get('/agencyFilter', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Agency Filters
router.get('/agencyFilter/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Agency Filter
router.get('/agencyFilter/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Agency Filters
router.get('/agencyFilter.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Agency Filters
router.delete('/agencyFilter', permissionMiddlewareCreator.delete(), (request, response, next) => {
