...
const { bookingExtra } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('bookingExtra');

// This file contains the logic of every route in Forest Admin for the collection bookingExtra:
...
router.post('/bookingExtra', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Booking Extra
router.put('/bookingExtra/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/bookingExtra/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Booking Extras
router.get('/bookingExtra', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Booking Extras
router.get('/bookingExtra/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Booking Extra
router.get('/bookingExtra/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Booking Extras
router.get('/bookingExtra.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Booking Extras
router.delete('/bookingExtra', permissionMiddlewareCreator.delete(), (request, response, next) => {
