...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('vehicleType');

// This file contains the logic of every route in Forest Admin for the collection vehicleType:
...
router.post('/vehicleType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/vehicleType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/vehicleType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/vehicleType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Vehicle Types
router.get('/vehicleType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Vehicle Type
router.get('/vehicleType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Vehicle Types
router.get('/vehicleType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Vehicle Types
router.delete('/vehicleType', permissionMiddlewareCreator.delete(), (request, response, next) => {
