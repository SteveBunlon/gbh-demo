...
const { extraType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('extraType');

// This file contains the logic of every route in Forest Admin for the collection extraType:
...
// Create a Extra Type
router.post('/extraType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Extra Type
router.put('/extraType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Extra Type
router.delete('/extraType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Extra Types
router.get('/extraType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Extra Types
router.get('/extraType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Extra Type
router.get('/extraType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Extra Types
router.get('/extraType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Extra Types
router.delete('/extraType', permissionMiddlewareCreator.delete(), (request, response, next) => {
