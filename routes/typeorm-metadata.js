...
const { typeormMetadata } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('typeormMetadata');

// This file contains the logic of every route in Forest Admin for the collection typeormMetadata:
...
// Create a Typeorm Metadatum
router.post('/typeormMetadata', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Typeorm Metadatum
router.put('/typeormMetadata/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Typeorm Metadatum
router.delete('/typeormMetadata/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Typeorm Metadata
router.get('/typeormMetadata', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Typeorm Metadata
router.get('/typeormMetadata/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Typeorm Metadatum
router.get('/typeormMetadata/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Typeorm Metadata
router.get('/typeormMetadata.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Typeorm Metadata
router.delete('/typeormMetadata', permissionMiddlewareCreator.delete(), (request, response, next) => {
