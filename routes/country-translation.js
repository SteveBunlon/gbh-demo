...
const { countryTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('countryTranslation');

// This file contains the logic of every route in Forest Admin for the collection countryTranslation:
...
// Create a Country Translation
router.post('/countryTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Country Translation
router.put('/countryTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Country Translation
router.delete('/countryTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Country Translations
router.get('/countryTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Country Translations
router.get('/countryTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Country Translation
router.get('/countryTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Country Translations
router.get('/countryTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Country Translations
router.delete('/countryTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
