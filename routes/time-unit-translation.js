...
const { timeUnitTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('timeUnitTranslation');

// This file contains the logic of every route in Forest Admin for the collection timeUnitTranslation:
...
// Create a Time Unit Translation
router.post('/timeUnitTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Time Unit Translation
router.put('/timeUnitTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Time Unit Translation
router.delete('/timeUnitTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Time Unit Translations
router.get('/timeUnitTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Time Unit Translations
router.get('/timeUnitTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Time Unit Translation
router.get('/timeUnitTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Time Unit Translations
router.get('/timeUnitTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Time Unit Translations
router.delete('/timeUnitTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
