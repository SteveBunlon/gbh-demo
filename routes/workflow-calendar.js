...
const { workflowCalendar } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('workflowCalendar');

// This file contains the logic of every route in Forest Admin for the collection workflowCalendar:
...
// Create a Workflow Calendar
router.post('/workflowCalendar', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Workflow Calendar
router.put('/workflowCalendar/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Workflow Calendar
router.delete('/workflowCalendar/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Workflow Calendars
router.get('/workflowCalendar', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Workflow Calendars
router.get('/workflowCalendar/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Workflow Calendar
router.get('/workflowCalendar/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Workflow Calendars
router.get('/workflowCalendar.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Workflow Calendars
router.delete('/workflowCalendar', permissionMiddlewareCreator.delete(), (request, response, next) => {
