...
const { redirectType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('redirectType');

// This file contains the logic of every route in Forest Admin for the collection redirectType:
...
// Create a Redirect Type
router.post('/redirectType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Redirect Type
router.put('/redirectType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Redirect Type
router.delete('/redirectType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Redirect Types
router.get('/redirectType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Redirect Types
router.get('/redirectType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Redirect Type
router.get('/redirectType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Redirect Types
router.get('/redirectType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Redirect Types
router.delete('/redirectType', permissionMiddlewareCreator.delete(), (request, response, next) => {
