...
const { bookingStateErp } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('bookingStateErp');

// This file contains the logic of every route in Forest Admin for the collection bookingStateErp:
...
// Create a Booking State Erp
router.post('/bookingStateErp', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Booking State Erp
router.put('/bookingStateErp/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Booking State Erp
router.delete('/bookingStateErp/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Booking State Erps
router.get('/bookingStateErp', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Booking State Erps
router.get('/bookingStateErp/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Booking State Erp
router.get('/bookingStateErp/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Booking State Erps
router.get('/bookingStateErp.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Booking State Erps
router.delete('/bookingStateErp', permissionMiddlewareCreator.delete(), (request, response, next) => {
