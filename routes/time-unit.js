...
const { timeUnit } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('timeUnit');

// This file contains the logic of every route in Forest Admin for the collection timeUnit:
...
// Create a Time Unit
router.post('/timeUnit', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Time Unit
router.put('/timeUnit/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Time Unit
router.delete('/timeUnit/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Time Units
router.get('/timeUnit', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Time Units
router.get('/timeUnit/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Time Unit
router.get('/timeUnit/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Time Units
router.get('/timeUnit.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Time Units
router.delete('/timeUnit', permissionMiddlewareCreator.delete(), (request, response, next) => {
