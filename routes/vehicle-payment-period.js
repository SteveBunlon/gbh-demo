...
const { vehiclePaymentPeriod } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('vehiclePaymentPeriod');

// This file contains the logic of every route in Forest Admin for the collection vehiclePaymentPeriod:
...
// Create a Vehicle Payment Period
router.post('/vehiclePaymentPeriod', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Vehicle Payment Period
router.put('/vehiclePaymentPeriod/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Vehicle Payment Period
router.delete('/vehiclePaymentPeriod/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Vehicle Payment Periods
router.get('/vehiclePaymentPeriod', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Vehicle Payment Periods
router.get('/vehiclePaymentPeriod/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Vehicle Payment Period
router.get('/vehiclePaymentPeriod/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Vehicle Payment Periods
router.get('/vehiclePaymentPeriod.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Vehicle Payment Periods
router.delete('/vehiclePaymentPeriod', permissionMiddlewareCreator.delete(), (request, response, next) => {
