...
// Get a Transaction
router.get('/transaction/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.delete('/transaction', permissionMiddlewareCreator.delete(), (request, response, next) => {
