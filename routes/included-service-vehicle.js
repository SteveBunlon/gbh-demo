...
const { includedServiceVehicle } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('includedServiceVehicle');

// This file contains the logic of every route in Forest Admin for the collection includedServiceVehicle:
...
// Create a Included Service Vehicle
router.post('/includedServiceVehicle', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Included Service Vehicle
router.put('/includedServiceVehicle/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Included Service Vehicle
router.delete('/includedServiceVehicle/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Included Service Vehicles
router.get('/includedServiceVehicle', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Included Service Vehicles
router.get('/includedServiceVehicle/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Included Service Vehicle
router.get('/includedServiceVehicle/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Included Service Vehicles
router.get('/includedServiceVehicle.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Included Service Vehicles
router.delete('/includedServiceVehicle', permissionMiddlewareCreator.delete(), (request, response, next) => {
