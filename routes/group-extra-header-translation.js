...
const { groupExtraHeaderTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('groupExtraHeaderTranslation');

// This file contains the logic of every route in Forest Admin for the collection groupExtraHeaderTranslation:
...
// Create a Group Extra Header Translation
router.post('/groupExtraHeaderTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Group Extra Header Translation
router.put('/groupExtraHeaderTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Group Extra Header Translation
router.delete('/groupExtraHeaderTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Group Extra Header Translations
router.get('/groupExtraHeaderTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Group Extra Header Translations
router.get('/groupExtraHeaderTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Group Extra Header Translation
router.get('/groupExtraHeaderTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Group Extra Header Translations
router.get('/groupExtraHeaderTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Group Extra Header Translations
router.delete('/groupExtraHeaderTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
