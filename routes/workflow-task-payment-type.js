...
const { workflowTaskPaymentType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('workflowTaskPaymentType');

// This file contains the logic of every route in Forest Admin for the collection workflowTaskPaymentType:
...
// Create a Workflow Task Payment Type
router.post('/workflowTaskPaymentType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Workflow Task Payment Type
router.put('/workflowTaskPaymentType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Workflow Task Payment Type
router.delete('/workflowTaskPaymentType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Workflow Task Payment Types
router.get('/workflowTaskPaymentType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Workflow Task Payment Types
router.get('/workflowTaskPaymentType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Workflow Task Payment Type
router.get('/workflowTaskPaymentType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Workflow Task Payment Types
router.get('/workflowTaskPaymentType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Workflow Task Payment Types
router.delete('/workflowTaskPaymentType', permissionMiddlewareCreator.delete(), (request, response, next) => {
