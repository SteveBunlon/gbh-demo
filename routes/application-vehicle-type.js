...
const { applicationVehicleType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('applicationVehicleType');

// This file contains the logic of every route in Forest Admin for the collection applicationVehicleType:
...
// Create a Application Vehicle Type
router.post('/applicationVehicleType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Application Vehicle Type
router.put('/applicationVehicleType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Application Vehicle Type
router.delete('/applicationVehicleType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Application Vehicle Types
router.get('/applicationVehicleType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Application Vehicle Types
router.get('/applicationVehicleType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Application Vehicle Type
router.get('/applicationVehicleType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Application Vehicle Types
router.get('/applicationVehicleType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Application Vehicle Types
router.delete('/applicationVehicleType', permissionMiddlewareCreator.delete(), (request, response, next) => {
