...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('branch');

// This file contains the logic of every route in Forest Admin for the collection branch:
...
// Create a Branch
router.post('/branch', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Branch
router.put('/branch/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Branch
router.delete('/branch/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/branch', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Branches
router.get('/branch/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Branch
router.get('/branch/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Branches
router.get('/branch.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/branch', permissionMiddlewareCreator.delete(), (request, response, next) => {
