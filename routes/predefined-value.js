...
const { predefinedValue } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('predefinedValue');

// This file contains the logic of every route in Forest Admin for the collection predefinedValue:
...
router.post('/predefinedValue', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/predefinedValue/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/predefinedValue/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Predefined Values
router.get('/predefinedValue', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Predefined Values
router.get('/predefinedValue/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/predefinedValue/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Predefined Values
router.get('/predefinedValue.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Predefined Values
router.delete('/predefinedValue', permissionMiddlewareCreator.delete(), (request, response, next) => {
