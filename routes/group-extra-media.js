...
const { groupExtraMedia } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('groupExtraMedia');

// This file contains the logic of every route in Forest Admin for the collection groupExtraMedia:
...
// Create a Group Extra Media
router.post('/groupExtraMedia', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Group Extra Media
router.put('/groupExtraMedia/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Group Extra Media
router.delete('/groupExtraMedia/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Group Extra Medias
router.get('/groupExtraMedia', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Group Extra Medias
router.get('/groupExtraMedia/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Group Extra Media
router.get('/groupExtraMedia/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Group Extra Medias
router.get('/groupExtraMedia.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Group Extra Medias
router.delete('/groupExtraMedia', permissionMiddlewareCreator.delete(), (request, response, next) => {
