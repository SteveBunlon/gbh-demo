...
const { extraDetail } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('extraDetail');

// This file contains the logic of every route in Forest Admin for the collection extraDetail:
...
// Create a Extra Detail
router.post('/extraDetail', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Extra Detail
router.put('/extraDetail/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Extra Detail
router.delete('/extraDetail/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Extra Details
router.get('/extraDetail', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Extra Details
router.get('/extraDetail/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Extra Detail
router.get('/extraDetail/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Extra Details
router.get('/extraDetail.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Extra Details
router.delete('/extraDetail', permissionMiddlewareCreator.delete(), (request, response, next) => {
