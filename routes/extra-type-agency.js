...
const { extraTypeAgency } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('extraTypeAgency');

// This file contains the logic of every route in Forest Admin for the collection extraTypeAgency:
...
// Create a Extra Type Agency
router.post('/extraTypeAgency', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Extra Type Agency
router.put('/extraTypeAgency/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Extra Type Agency
router.delete('/extraTypeAgency/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Extra Type Agencies
router.get('/extraTypeAgency', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Extra Type Agencies
router.get('/extraTypeAgency/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Extra Type Agency
router.get('/extraTypeAgency/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Extra Type Agencies
router.get('/extraTypeAgency.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Extra Type Agencies
router.delete('/extraTypeAgency', permissionMiddlewareCreator.delete(), (request, response, next) => {
