...
const { workflowTaskExtra } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('workflowTaskExtra');

// This file contains the logic of every route in Forest Admin for the collection workflowTaskExtra:
...
// Create a Workflow Task Extra
router.post('/workflowTaskExtra', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Workflow Task Extra
router.put('/workflowTaskExtra/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Workflow Task Extra
router.delete('/workflowTaskExtra/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Workflow Task Extras
router.get('/workflowTaskExtra', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Workflow Task Extras
router.get('/workflowTaskExtra/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Workflow Task Extra
router.get('/workflowTaskExtra/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Workflow Task Extras
router.get('/workflowTaskExtra.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Workflow Task Extras
router.delete('/workflowTaskExtra', permissionMiddlewareCreator.delete(), (request, response, next) => {
