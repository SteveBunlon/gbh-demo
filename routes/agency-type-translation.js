...
const { agencyTypeTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('agencyTypeTranslation');

// This file contains the logic of every route in Forest Admin for the collection agencyTypeTranslation:
...
// Create a Agency Type Translation
router.post('/agencyTypeTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Agency Type Translation
router.put('/agencyTypeTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Agency Type Translation
router.delete('/agencyTypeTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Agency Type Translations
router.get('/agencyTypeTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Agency Type Translations
router.get('/agencyTypeTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Agency Type Translation
router.get('/agencyTypeTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Agency Type Translations
router.get('/agencyTypeTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Agency Type Translations
router.delete('/agencyTypeTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
