...
const { rateVehicleValue } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('rateVehicleValue');

// This file contains the logic of every route in Forest Admin for the collection rateVehicleValue:
...
// Create a Rate Vehicle Value
router.post('/rateVehicleValue', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Rate Vehicle Value
router.put('/rateVehicleValue/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Rate Vehicle Value
router.delete('/rateVehicleValue/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Rate Vehicle Values
router.get('/rateVehicleValue', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Rate Vehicle Values
router.get('/rateVehicleValue/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Rate Vehicle Value
router.get('/rateVehicleValue/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Rate Vehicle Values
router.get('/rateVehicleValue.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Rate Vehicle Values
router.delete('/rateVehicleValue', permissionMiddlewareCreator.delete(), (request, response, next) => {
