...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('vehicle');

// This file contains the logic of every route in Forest Admin for the collection vehicle:
...
// Create a Vehicle
router.post('/vehicle', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Vehicle
router.put('/vehicle/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Vehicle
router.delete('/vehicle/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/vehicle', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Vehicles
router.get('/vehicle/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Vehicle
router.get('/vehicle/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/vehicle.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Vehicles
router.delete('/vehicle', permissionMiddlewareCreator.delete(), (request, response, next) => {
