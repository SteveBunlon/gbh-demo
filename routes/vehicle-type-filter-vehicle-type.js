...
const { vehicleTypeFilterVehicleType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('vehicleTypeFilterVehicleType');

// This file contains the logic of every route in Forest Admin for the collection vehicleTypeFilterVehicleType:
...
// Create a Vehicle Type Filter Vehicle Type
router.post('/vehicleTypeFilterVehicleType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Vehicle Type Filter Vehicle Type
router.put('/vehicleTypeFilterVehicleType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Vehicle Type Filter Vehicle Type
router.delete('/vehicleTypeFilterVehicleType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Vehicle Type Filter Vehicle Types
router.get('/vehicleTypeFilterVehicleType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Vehicle Type Filter Vehicle Types
router.get('/vehicleTypeFilterVehicleType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Vehicle Type Filter Vehicle Type
router.get('/vehicleTypeFilterVehicleType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Vehicle Type Filter Vehicle Types
router.get('/vehicleTypeFilterVehicleType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Vehicle Type Filter Vehicle Types
router.delete('/vehicleTypeFilterVehicleType', permissionMiddlewareCreator.delete(), (request, response, next) => {
