...
const { mediaTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('mediaTranslation');

// This file contains the logic of every route in Forest Admin for the collection mediaTranslation:
...
// Create a Media Translation
router.post('/mediaTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/mediaTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/mediaTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Media Translations
router.get('/mediaTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Media Translations
router.get('/mediaTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Media Translation
router.get('/mediaTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Media Translations
router.get('/mediaTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Media Translations
router.delete('/mediaTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
