...
const { vehicleTypeFilter } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('vehicleTypeFilter');

// This file contains the logic of every route in Forest Admin for the collection vehicleTypeFilter:
...
// Create a Vehicle Type Filter
router.post('/vehicleTypeFilter', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Vehicle Type Filter
router.put('/vehicleTypeFilter/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Vehicle Type Filter
router.delete('/vehicleTypeFilter/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Vehicle Type Filters
router.get('/vehicleTypeFilter', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Vehicle Type Filters
router.get('/vehicleTypeFilter/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Vehicle Type Filter
router.get('/vehicleTypeFilter/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Vehicle Type Filters
router.get('/vehicleTypeFilter.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Vehicle Type Filters
router.delete('/vehicleTypeFilter', permissionMiddlewareCreator.delete(), (request, response, next) => {
