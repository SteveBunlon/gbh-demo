...
const { secondaryVehicleType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('secondaryVehicleType');

// This file contains the logic of every route in Forest Admin for the collection secondaryVehicleType:
...
// Create a Secondary Vehicle Type
router.post('/secondaryVehicleType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Secondary Vehicle Type
router.put('/secondaryVehicleType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Secondary Vehicle Type
router.delete('/secondaryVehicleType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Secondary Vehicle Types
router.get('/secondaryVehicleType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Secondary Vehicle Types
router.get('/secondaryVehicleType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Secondary Vehicle Type
router.get('/secondaryVehicleType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Secondary Vehicle Types
router.get('/secondaryVehicleType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Secondary Vehicle Types
router.delete('/secondaryVehicleType', permissionMiddlewareCreator.delete(), (request, response, next) => {
