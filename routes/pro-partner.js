...
const { proPartner } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('proPartner');

// This file contains the logic of every route in Forest Admin for the collection proPartner:
...
// Create a Pro Partner
router.post('/proPartner', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Pro Partner
router.put('/proPartner/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Pro Partner
router.delete('/proPartner/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Pro Partners
router.get('/proPartner', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Pro Partners
router.get('/proPartner/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Pro Partner
router.get('/proPartner/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Pro Partners
router.get('/proPartner.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Pro Partners
router.delete('/proPartner', permissionMiddlewareCreator.delete(), (request, response, next) => {
