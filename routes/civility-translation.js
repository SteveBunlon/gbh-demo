...
const { civilityTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('civilityTranslation');

// This file contains the logic of every route in Forest Admin for the collection civilityTranslation:
...
// Create a Civility Translation
router.post('/civilityTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Civility Translation
router.put('/civilityTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Civility Translation
router.delete('/civilityTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Civility Translations
router.get('/civilityTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Civility Translations
router.get('/civilityTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Civility Translation
router.get('/civilityTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Civility Translations
router.get('/civilityTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Civility Translations
router.delete('/civilityTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
