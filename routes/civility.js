...
const { civility } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('civility');

// This file contains the logic of every route in Forest Admin for the collection civility:
...
// Create a Civility
router.post('/civility', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Civility
router.put('/civility/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Civility
router.delete('/civility/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Civilities
router.get('/civility', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Civilities
router.get('/civility/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Civility
router.get('/civility/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Civilities
router.get('/civility.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Civilities
router.delete('/civility', permissionMiddlewareCreator.delete(), (request, response, next) => {
