...
const { bookingActionType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('bookingActionType');

// This file contains the logic of every route in Forest Admin for the collection bookingActionType:
...
// Create a Booking Action Type
router.post('/bookingActionType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Booking Action Type
router.put('/bookingActionType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Booking Action Type
router.delete('/bookingActionType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Booking Action Types
router.get('/bookingActionType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Booking Action Types
router.get('/bookingActionType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Booking Action Type
router.get('/bookingActionType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Booking Action Types
router.get('/bookingActionType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Booking Action Types
router.delete('/bookingActionType', permissionMiddlewareCreator.delete(), (request, response, next) => {
