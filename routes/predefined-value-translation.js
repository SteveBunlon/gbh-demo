...
const { predefinedValueTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('predefinedValueTranslation');

// This file contains the logic of every route in Forest Admin for the collection predefinedValueTranslation:
...
// Create a Predefined Value Translation
router.post('/predefinedValueTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Predefined Value Translation
router.put('/predefinedValueTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Predefined Value Translation
router.delete('/predefinedValueTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Predefined Value Translations
router.get('/predefinedValueTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Predefined Value Translations
router.get('/predefinedValueTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Predefined Value Translation
router.get('/predefinedValueTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Predefined Value Translations
router.get('/predefinedValueTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Predefined Value Translations
router.delete('/predefinedValueTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
