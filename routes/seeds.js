...
const { seeds } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('seeds');

// This file contains the logic of every route in Forest Admin for the collection seeds:
...
// Create a Seed
router.post('/seeds', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Seed
router.put('/seeds/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Seed
router.delete('/seeds/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Seeds
router.get('/seeds', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Seeds
router.get('/seeds/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Seed
router.get('/seeds/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Seeds
router.get('/seeds.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Seeds
router.delete('/seeds', permissionMiddlewareCreator.delete(), (request, response, next) => {
