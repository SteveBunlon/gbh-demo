...
const { leadAttachment } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('leadAttachment');

// This file contains the logic of every route in Forest Admin for the collection leadAttachment:
...
// Create a Lead Attachment
router.post('/leadAttachment', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/leadAttachment/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/leadAttachment/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Lead Attachments
router.get('/leadAttachment', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Lead Attachments
router.get('/leadAttachment/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Lead Attachment
router.get('/leadAttachment/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Lead Attachments
router.get('/leadAttachment.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Lead Attachments
router.delete('/leadAttachment', permissionMiddlewareCreator.delete(), (request, response, next) => {
