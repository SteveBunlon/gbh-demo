...
const { rateVehicleExtra } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('rateVehicleExtra');

// This file contains the logic of every route in Forest Admin for the collection rateVehicleExtra:
...
// Create a Rate Vehicle Extra
router.post('/rateVehicleExtra', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Rate Vehicle Extra
router.put('/rateVehicleExtra/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Rate Vehicle Extra
router.delete('/rateVehicleExtra/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Rate Vehicle Extras
router.get('/rateVehicleExtra', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Rate Vehicle Extras
router.get('/rateVehicleExtra/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Rate Vehicle Extra
router.get('/rateVehicleExtra/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Rate Vehicle Extras
router.get('/rateVehicleExtra.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Rate Vehicle Extras
router.delete('/rateVehicleExtra', permissionMiddlewareCreator.delete(), (request, response, next) => {
