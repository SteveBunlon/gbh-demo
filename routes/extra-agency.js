...
const { extraAgency } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('extraAgency');

// This file contains the logic of every route in Forest Admin for the collection extraAgency:
...
// Create a Extra Agency
router.post('/extraAgency', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Extra Agency
router.put('/extraAgency/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Extra Agency
router.delete('/extraAgency/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Extra Agencies
router.get('/extraAgency', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Extra Agencies
router.get('/extraAgency/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Extra Agency
router.get('/extraAgency/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Extra Agencies
router.get('/extraAgency.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Extra Agencies
router.delete('/extraAgency', permissionMiddlewareCreator.delete(), (request, response, next) => {
