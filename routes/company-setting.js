...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('companySetting');

// This file contains the logic of every route in Forest Admin for the collection companySetting:
...
router.post('/companySetting', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/companySetting/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/companySetting/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/companySetting', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Company Settings
router.get('/companySetting/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/companySetting/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Company Settings
router.get('/companySetting.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Company Settings
router.delete('/companySetting', permissionMiddlewareCreator.delete(), (request, response, next) => {
