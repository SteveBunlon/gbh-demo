...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('mediaType');

// This file contains the logic of every route in Forest Admin for the collection mediaType:
...
// Create a Media Type
router.post('/mediaType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Media Type
router.put('/mediaType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Media Type
router.delete('/mediaType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/mediaType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Media Types
router.get('/mediaType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Media Type
router.get('/mediaType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Media Types
router.get('/mediaType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Media Types
router.delete('/mediaType', permissionMiddlewareCreator.delete(), (request, response, next) => {
