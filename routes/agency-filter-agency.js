...
const { agencyFilterAgency } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('agencyFilterAgency');

// This file contains the logic of every route in Forest Admin for the collection agencyFilterAgency:
...
// Create a Agency Filter Agency
router.post('/agencyFilterAgency', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Agency Filter Agency
router.put('/agencyFilterAgency/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Agency Filter Agency
router.delete('/agencyFilterAgency/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Agency Filter Agencies
router.get('/agencyFilterAgency', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Agency Filter Agencies
router.get('/agencyFilterAgency/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Agency Filter Agency
router.get('/agencyFilterAgency/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Agency Filter Agencies
router.get('/agencyFilterAgency.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Agency Filter Agencies
router.delete('/agencyFilterAgency', permissionMiddlewareCreator.delete(), (request, response, next) => {
