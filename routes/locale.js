...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('locale');

// This file contains the logic of every route in Forest Admin for the collection locale:
...
// Create a Locale
router.post('/locale', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Locale
router.put('/locale/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Locale
router.delete('/locale/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/locale', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Locales
router.get('/locale/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Locale
router.get('/locale/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Locales
router.get('/locale.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Locales
router.delete('/locale', permissionMiddlewareCreator.delete(), (request, response, next) => {
