...
const { groupExtraTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('groupExtraTranslation');

// This file contains the logic of every route in Forest Admin for the collection groupExtraTranslation:
...
// Create a Group Extra Translation
router.post('/groupExtraTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Group Extra Translation
router.put('/groupExtraTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Group Extra Translation
router.delete('/groupExtraTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Group Extra Translations
router.get('/groupExtraTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Group Extra Translations
router.get('/groupExtraTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Group Extra Translation
router.get('/groupExtraTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Group Extra Translations
router.get('/groupExtraTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Group Extra Translations
router.delete('/groupExtraTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
