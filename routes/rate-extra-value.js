...
const { rateExtraValue } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('rateExtraValue');

// This file contains the logic of every route in Forest Admin for the collection rateExtraValue:
...
// Create a Rate Extra Value
router.post('/rateExtraValue', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Rate Extra Value
router.put('/rateExtraValue/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Rate Extra Value
router.delete('/rateExtraValue/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Rate Extra Values
router.get('/rateExtraValue', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Rate Extra Values
router.get('/rateExtraValue/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Rate Extra Value
router.get('/rateExtraValue/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Rate Extra Values
router.get('/rateExtraValue.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Rate Extra Values
router.delete('/rateExtraValue', permissionMiddlewareCreator.delete(), (request, response, next) => {
