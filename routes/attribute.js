...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('attribute');

// This file contains the logic of every route in Forest Admin for the collection attribute:
...
// Create a Attribute
router.post('/attribute', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Attribute
router.put('/attribute/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Attribute
router.delete('/attribute/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/attribute', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/attribute/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Attribute
router.get('/attribute/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Attributes
router.get('/attribute.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/attribute', permissionMiddlewareCreator.delete(), (request, response, next) => {
