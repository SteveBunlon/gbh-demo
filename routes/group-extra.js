...
const { groupExtra } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('groupExtra');

// This file contains the logic of every route in Forest Admin for the collection groupExtra:
...
// Create a Group Extra
router.post('/groupExtra', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/groupExtra/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Group Extra
router.delete('/groupExtra/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Group Extras
router.get('/groupExtra', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Group Extras
router.get('/groupExtra/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Group Extra
router.get('/groupExtra/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Group Extras
router.get('/groupExtra.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Group Extras
router.delete('/groupExtra', permissionMiddlewareCreator.delete(), (request, response, next) => {
