...
const { vehicleTypeLink } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('vehicleTypeLink');

// This file contains the logic of every route in Forest Admin for the collection vehicleTypeLink:
...
// Create a Vehicle Type Link
router.post('/vehicleTypeLink', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Vehicle Type Link
router.put('/vehicleTypeLink/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Vehicle Type Link
router.delete('/vehicleTypeLink/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Vehicle Type Links
router.get('/vehicleTypeLink', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Vehicle Type Links
router.get('/vehicleTypeLink/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Vehicle Type Link
router.get('/vehicleTypeLink/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Vehicle Type Links
router.get('/vehicleTypeLink.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Vehicle Type Links
router.delete('/vehicleTypeLink', permissionMiddlewareCreator.delete(), (request, response, next) => {
