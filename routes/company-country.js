...
const { companyCountry } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('companyCountry');

// This file contains the logic of every route in Forest Admin for the collection companyCountry:
...
router.post('/companyCountry', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/companyCountry/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/companyCountry/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Company Countries
router.get('/companyCountry', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Company Countries
router.get('/companyCountry/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Company Country
router.get('/companyCountry/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Company Countries
router.get('/companyCountry.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Company Countries
router.delete('/companyCountry', permissionMiddlewareCreator.delete(), (request, response, next) => {
