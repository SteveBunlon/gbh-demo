...
const { additionalDriver } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('additionalDriver');

// This file contains the logic of every route in Forest Admin for the collection additionalDriver:
...
// Create a Additional Driver
router.post('/additionalDriver', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Additional Driver
router.put('/additionalDriver/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Additional Driver
router.delete('/additionalDriver/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Additional Drivers
router.get('/additionalDriver', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Additional Drivers
router.get('/additionalDriver/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Additional Driver
router.get('/additionalDriver/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Additional Drivers
router.get('/additionalDriver.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Additional Drivers
router.delete('/additionalDriver', permissionMiddlewareCreator.delete(), (request, response, next) => {
