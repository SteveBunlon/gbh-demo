...
const { leadFormType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('leadFormType');

// This file contains the logic of every route in Forest Admin for the collection leadFormType:
...
// Create a Lead Form Type
router.post('/leadFormType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Lead Form Type
router.put('/leadFormType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Lead Form Type
router.delete('/leadFormType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Lead Form Types
router.get('/leadFormType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Lead Form Types
router.get('/leadFormType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Lead Form Type
router.get('/leadFormType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Lead Form Types
router.get('/leadFormType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Lead Form Types
router.delete('/leadFormType', permissionMiddlewareCreator.delete(), (request, response, next) => {
