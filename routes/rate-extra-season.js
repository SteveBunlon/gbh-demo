...
const { rateExtraSeason } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('rateExtraSeason');

// This file contains the logic of every route in Forest Admin for the collection rateExtraSeason:
...
// Create a Rate Extra Season
router.post('/rateExtraSeason', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Rate Extra Season
router.put('/rateExtraSeason/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Rate Extra Season
router.delete('/rateExtraSeason/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Rate Extra Seasons
router.get('/rateExtraSeason', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Rate Extra Seasons
router.get('/rateExtraSeason/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Rate Extra Season
router.get('/rateExtraSeason/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Rate Extra Seasons
router.get('/rateExtraSeason.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Rate Extra Seasons
router.delete('/rateExtraSeason', permissionMiddlewareCreator.delete(), (request, response, next) => {
