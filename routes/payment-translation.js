...
const { paymentTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('paymentTranslation');

// This file contains the logic of every route in Forest Admin for the collection paymentTranslation:
...
// Create a Payment Translation
router.post('/paymentTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Payment Translation
router.put('/paymentTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Payment Translation
router.delete('/paymentTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Payment Translations
router.get('/paymentTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Payment Translations
router.get('/paymentTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Payment Translation
router.get('/paymentTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Payment Translations
router.get('/paymentTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Payment Translations
router.delete('/paymentTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
