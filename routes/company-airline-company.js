...
const { companyAirlineCompany } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('companyAirlineCompany');

// This file contains the logic of every route in Forest Admin for the collection companyAirlineCompany:
...
// Create a Company Airline Company
router.post('/companyAirlineCompany', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Company Airline Company
router.put('/companyAirlineCompany/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Company Airline Company
router.delete('/companyAirlineCompany/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Company Airline Companies
router.get('/companyAirlineCompany', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Company Airline Companies
router.get('/companyAirlineCompany/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Company Airline Company
router.get('/companyAirlineCompany/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Company Airline Companies
router.get('/companyAirlineCompany.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Company Airline Companies
router.delete('/companyAirlineCompany', permissionMiddlewareCreator.delete(), (request, response, next) => {
