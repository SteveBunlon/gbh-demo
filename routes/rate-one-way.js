...
const { rateOneWay } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('rateOneWay');

// This file contains the logic of every route in Forest Admin for the collection rateOneWay:
...
// Create a Rate One Way
router.post('/rateOneWay', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Rate One Way
router.put('/rateOneWay/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Rate One Way
router.delete('/rateOneWay/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Rate One Ways
router.get('/rateOneWay', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Rate One Ways
router.get('/rateOneWay/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Rate One Way
router.get('/rateOneWay/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Rate One Ways
router.get('/rateOneWay.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Rate One Ways
router.delete('/rateOneWay', permissionMiddlewareCreator.delete(), (request, response, next) => {
