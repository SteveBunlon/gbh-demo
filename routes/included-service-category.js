...
const { includedServiceCategory } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('includedServiceCategory');

// This file contains the logic of every route in Forest Admin for the collection includedServiceCategory:
...
// Create a Included Service Category
router.post('/includedServiceCategory', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Included Service Category
router.put('/includedServiceCategory/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Included Service Category
router.delete('/includedServiceCategory/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Included Service Categories
router.get('/includedServiceCategory', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Included Service Categories
router.get('/includedServiceCategory/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Included Service Category
router.get('/includedServiceCategory/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Included Service Categories
router.get('/includedServiceCategory.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Included Service Categories
router.delete('/includedServiceCategory', permissionMiddlewareCreator.delete(), (request, response, next) => {
