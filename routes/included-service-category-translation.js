...
const { includedServiceCategoryTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('includedServiceCategoryTranslation');

// This file contains the logic of every route in Forest Admin for the collection includedServiceCategoryTranslation:
...
// Create a Included Service Category Translation
router.post('/includedServiceCategoryTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Included Service Category Translation
router.put('/includedServiceCategoryTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Included Service Category Translation
router.delete('/includedServiceCategoryTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Included Service Category Translations
router.get('/includedServiceCategoryTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Included Service Category Translations
router.get('/includedServiceCategoryTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Included Service Category Translation
router.get('/includedServiceCategoryTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Included Service Category Translations
router.get('/includedServiceCategoryTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Included Service Category Translations
router.delete('/includedServiceCategoryTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
