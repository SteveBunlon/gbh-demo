...
const { typeRequestTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('typeRequestTranslation');

// This file contains the logic of every route in Forest Admin for the collection typeRequestTranslation:
...
// Create a Type Request Translation
router.post('/typeRequestTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Type Request Translation
router.put('/typeRequestTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Type Request Translation
router.delete('/typeRequestTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Type Request Translations
router.get('/typeRequestTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Type Request Translations
router.get('/typeRequestTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Type Request Translation
router.get('/typeRequestTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Type Request Translations
router.get('/typeRequestTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Type Request Translations
router.delete('/typeRequestTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
