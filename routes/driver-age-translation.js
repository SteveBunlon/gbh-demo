...
const { driverAgeTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('driverAgeTranslation');

// This file contains the logic of every route in Forest Admin for the collection driverAgeTranslation:
...
// Create a Driver Age Translation
router.post('/driverAgeTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Driver Age Translation
router.put('/driverAgeTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Driver Age Translation
router.delete('/driverAgeTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Driver Age Translations
router.get('/driverAgeTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Driver Age Translations
router.get('/driverAgeTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Driver Age Translation
router.get('/driverAgeTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Driver Age Translations
router.get('/driverAgeTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Driver Age Translations
router.delete('/driverAgeTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
