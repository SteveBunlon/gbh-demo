...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('attributeValue');

// This file contains the logic of every route in Forest Admin for the collection attributeValue:
...
router.post('/attributeValue', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/attributeValue/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Attribute Value
router.delete('/attributeValue/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/attributeValue', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Attribute Values
router.get('/attributeValue/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/attributeValue/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Attribute Values
router.get('/attributeValue.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/attributeValue', permissionMiddlewareCreator.delete(), (request, response, next) => {
