...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('extra');

// This file contains the logic of every route in Forest Admin for the collection extra:
...
// Create a Extra
router.post('/extra', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Extra
router.put('/extra/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Extra
router.delete('/extra/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/extra', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Extras
router.get('/extra/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Extra
router.get('/extra/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Extras
router.get('/extra.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Extras
router.delete('/extra', permissionMiddlewareCreator.delete(), (request, response, next) => {
