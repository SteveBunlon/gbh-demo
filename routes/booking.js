...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('booking');

// This file contains the logic of every route in Forest Admin for the collection booking:
...
// Create a Booking
router.post('/booking', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Booking
router.put('/booking/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Booking
router.delete('/booking/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/booking', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/booking/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Booking
router.get('/booking/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/booking.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/booking', permissionMiddlewareCreator.delete(), (request, response, next) => {
