...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('agency');

// This file contains the logic of every route in Forest Admin for the collection agency:
...
// Create a Agency
router.post('/agency', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Agency
router.put('/agency/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Agency
router.delete('/agency/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/agency', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Agencies
router.get('/agency/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Agency
router.get('/agency/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Agencies
router.get('/agency.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Agencies
router.delete('/agency', permissionMiddlewareCreator.delete(), (request, response, next) => {
