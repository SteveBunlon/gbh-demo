...
const { branchTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('branchTranslation');

// This file contains the logic of every route in Forest Admin for the collection branchTranslation:
...
router.post('/branchTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/branchTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/branchTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Branch Translations
router.get('/branchTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Branch Translations
router.get('/branchTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Branch Translation
router.get('/branchTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Branch Translations
router.get('/branchTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Branch Translations
router.delete('/branchTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
