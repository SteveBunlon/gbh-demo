...
const { paymentTypeCategory } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('paymentTypeCategory');

// This file contains the logic of every route in Forest Admin for the collection paymentTypeCategory:
...
// Create a Payment Type Category
router.post('/paymentTypeCategory', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Payment Type Category
router.put('/paymentTypeCategory/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Payment Type Category
router.delete('/paymentTypeCategory/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Payment Type Categories
router.get('/paymentTypeCategory', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Payment Type Categories
router.get('/paymentTypeCategory/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Payment Type Category
router.get('/paymentTypeCategory/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Payment Type Categories
router.get('/paymentTypeCategory.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Payment Type Categories
router.delete('/paymentTypeCategory', permissionMiddlewareCreator.delete(), (request, response, next) => {
