...
const { paymentTypeTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('paymentTypeTranslation');

// This file contains the logic of every route in Forest Admin for the collection paymentTypeTranslation:
...
// Create a Payment Type Translation
router.post('/paymentTypeTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Payment Type Translation
router.put('/paymentTypeTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Payment Type Translation
router.delete('/paymentTypeTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Payment Type Translations
router.get('/paymentTypeTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Payment Type Translations
router.get('/paymentTypeTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Payment Type Translation
router.get('/paymentTypeTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Payment Type Translations
router.get('/paymentTypeTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Payment Type Translations
router.delete('/paymentTypeTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
