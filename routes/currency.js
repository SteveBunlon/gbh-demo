...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('currency');

// This file contains the logic of every route in Forest Admin for the collection currency:
...
// Create a Currency
router.post('/currency', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Currency
router.put('/currency/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Currency
router.delete('/currency/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/currency', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Currencies
router.get('/currency/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Currency
router.get('/currency/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Currencies
router.get('/currency.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/currency', permissionMiddlewareCreator.delete(), (request, response, next) => {
