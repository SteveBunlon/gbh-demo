...
const { bookingLinkedExtra } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('bookingLinkedExtra');

// This file contains the logic of every route in Forest Admin for the collection bookingLinkedExtra:
...
// Create a Booking Linked Extra
router.post('/bookingLinkedExtra', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Booking Linked Extra
router.put('/bookingLinkedExtra/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Booking Linked Extra
router.delete('/bookingLinkedExtra/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Booking Linked Extras
router.get('/bookingLinkedExtra', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Booking Linked Extras
router.get('/bookingLinkedExtra/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Booking Linked Extra
router.get('/bookingLinkedExtra/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Booking Linked Extras
router.get('/bookingLinkedExtra.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Booking Linked Extras
router.delete('/bookingLinkedExtra', permissionMiddlewareCreator.delete(), (request, response, next) => {
