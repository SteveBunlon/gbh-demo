...
const { agencySpecialSchedule } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('agencySpecialSchedule');

// This file contains the logic of every route in Forest Admin for the collection agencySpecialSchedule:
...
// Create a Agency Special Schedule
router.post('/agencySpecialSchedule', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Agency Special Schedule
router.put('/agencySpecialSchedule/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Agency Special Schedule
router.delete('/agencySpecialSchedule/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Agency Special Schedules
router.get('/agencySpecialSchedule', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Agency Special Schedules
router.get('/agencySpecialSchedule/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Agency Special Schedule
router.get('/agencySpecialSchedule/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Agency Special Schedules
router.get('/agencySpecialSchedule.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Agency Special Schedules
router.delete('/agencySpecialSchedule', permissionMiddlewareCreator.delete(), (request, response, next) => {
