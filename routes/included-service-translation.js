...
const { includedServiceTranslation } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('includedServiceTranslation');

// This file contains the logic of every route in Forest Admin for the collection includedServiceTranslation:
...
// Create a Included Service Translation
router.post('/includedServiceTranslation', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Included Service Translation
router.put('/includedServiceTranslation/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Included Service Translation
router.delete('/includedServiceTranslation/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Included Service Translations
router.get('/includedServiceTranslation', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Included Service Translations
router.get('/includedServiceTranslation/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Included Service Translation
router.get('/includedServiceTranslation/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Included Service Translations
router.get('/includedServiceTranslation.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Included Service Translations
router.delete('/includedServiceTranslation', permissionMiddlewareCreator.delete(), (request, response, next) => {
