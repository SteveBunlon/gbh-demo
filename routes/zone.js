...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('zone');

// This file contains the logic of every route in Forest Admin for the collection zone:
...
// Create a Zone
router.post('/zone', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Zone
router.put('/zone/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Zone
router.delete('/zone/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Zones
router.get('/zone', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/zone/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Zone
router.get('/zone/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/zone.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/zone', permissionMiddlewareCreator.delete(), (request, response, next) => {
