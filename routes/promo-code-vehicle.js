...
const { promoCodeVehicle } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('promoCodeVehicle');

// This file contains the logic of every route in Forest Admin for the collection promoCodeVehicle:
...
// Create a Promo Code Vehicle
router.post('/promoCodeVehicle', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Promo Code Vehicle
router.put('/promoCodeVehicle/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Promo Code Vehicle
router.delete('/promoCodeVehicle/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Promo Code Vehicles
router.get('/promoCodeVehicle', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Promo Code Vehicles
router.get('/promoCodeVehicle/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Promo Code Vehicle
router.get('/promoCodeVehicle/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Promo Code Vehicles
router.get('/promoCodeVehicle.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Promo Code Vehicles
router.delete('/promoCodeVehicle', permissionMiddlewareCreator.delete(), (request, response, next) => {
